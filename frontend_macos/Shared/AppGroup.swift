...
enum AppGroup {
    // На macOS контейнер App Group именуется с префиксом Team ID
    // (~/Library/Group Containers/<TeamID>.group.com.splitvpn.app), на iOS — без него.
    #if os(macOS)
    static let identifier = "Z3PM3LR5FF.group.com.splitvpn.app"
    #else
